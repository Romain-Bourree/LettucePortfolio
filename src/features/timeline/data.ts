...
export const TIMELINE_ITEMS: TimelineItem[] = [
  { name:'Freelance',   period:'2007 -> 2013',               type:'career', accent:'#ffffff', color:'#121212', side:'right', gap:90,  mt:36,  desc:'Early career freelance work alongside my Master degree: branding, small web projects, and first client relationships across France.' },
  { name:'Faktis',      period:'2009 – 2011',               type:'side',   accent:'#ffffff', color:'#121212', side:'left',  gap:50,  mt:18,  desc:'Co-founded a design collective bringing interaction design to musical events.' },
  { name:'Graduated',   period:'2010 · L\'École de Design', type:'life',   accent:'#ffffff', color:'#121212', side:'right', gap:130, mt:22,  desc:'MDes in Interaction Design and UX. Graduated with jury mention and highest honours.' },
  { name:'Dsquare',     period:'2010 – 2011',               type:'career', accent:'#0069FF', color:'#001D46', side:'left',  gap:30,  mt:30,  desc:'Interaction design at Dsquare, a design agency within Niji, working across digital products in Paris before the move to Canada.' },
  { name:'Invoke',      period:'2011 – 2013',               type:'career', accent:'#453BE7', color:'#120F40', side:'right', gap:60,  mt:28,  desc:'Design lead at a startup incubator, helping early-stage companies define strategy, build their brand, and ship their first product.' },
  { name:'Krushon',     period:'2012 – 2013',               type:'side',   accent:'#FC7350', color:'#35170F', side:'left',  gap:80,  mt:14,  desc:'Designed and shipped a mobile app for missed connections. First solo app from concept to launch.' },
  { name:'Qudos',       period:'2014 – 2015',               type:'career', accent:'#3DC9A5', color:'#09241D', side:'right', gap:110, mt:40,  desc:'Designed a B2B matchmaking platform making it easier for businesses to find and connect with the right service providers.' },
  { name:'Mogo',        period:'May 2016 – June 2020',      type:'career', accent:'#FF002A', color:'#2B0007', side:'right', gap:75,  mt:44,  desc:'Joined pre-IPO as Senior Designer and grew into Lead over five years, designing products and building the team as Mogo scaled from two products to seven.' },
  { name:'IBS & Me',    period:'2017 – 2018',               type:'side',   accent:'#F1ACB9', color:'#422E32', side:'left',  gap:65,  mt:20,  desc:'Got diagnosed with IBS, went through the elimination diet with nothing but a spreadsheet. So I designed something better.' },
  { name:'Bench',       period:'July 2020 – Jan 2023',      type:'career', accent:'#062D60', color:'#020E1F', side:'right', gap:140, mt:38,  desc:'Built the first unified design system at Bench and led the design team through a period of rapid scaling.' },
  { name:'Fromme Here', period:'2022 – 2024',               type:'side',   accent:'#FFAD93', color:'#2D1E1A', side:'left',  gap:40,  mt:16,  desc:'Created a local headwear brand for the North Shore mountain biking community, built to give back to the trails I ride.' },
  { name:'Arrived',     period:'Feb 2023 – Feb 2025',       type:'career', accent:'#156CD8', color:'#052143', side:'right', gap:95,  mt:32,  desc:'Led a full rebrand, design system overhaul, and investor portfolio redesign at a real estate fintech platform.' },
  { name:'H2H',         period:'Dec 2024 – Now',            type:'side',   accent:'#15EA9F', color:'#010B08', side:'left',  gap:70,  mt:26,  desc:'A personal challenge turned real product: learned Cursor, built a fantasy sports iOS app from scratch, and shipped it to the App Store solo.' },
  { name:'ASSET',       period:'Feb 2025 – Now',            type:'career', accent:'#2FEC61', color:'#00231D', side:'right', gap:55,  mt:50,  desc:'First designer in at an AI-driven fintech startup, building everything from brand to product to engineering contributions from scratch.' },
];
...
export const PANEL_DATA: Record<string, PanelEntry> = {
  ...
  ARRIVED: {
    ...
    tldr:
      'Arrived investors were drowning in data with no context for what it meant or what to do next. My role was to fix that: make the portfolio experience feel like guidance, not just a dashboard. That meant a new design system, a rebrand, and a ground-up redesign of the core investor experience across web and iOS.',
      gallery: [
        { src: '/images/Arrived/00%20-%20ArrivedHouse.jpg', alt: 'Arrived Portfolio' },
        { src: '/images/Arrived/01%20-%20ArrivedStyle.jpg', alt: 'Arrived Design Style' },
        { src: '/images/Arrived/02%20-%20Arrived3Screen.jpg', alt: 'Arrived Account' },
        { src: '/images/Arrived/03%20-%20ArrivedPeeps.jpg', alt: 'Arrived Blog Header' },
        { src: '/images/Arrived/04%20-%20Arrived2Screen.jpg', alt: 'Arrived Transaction' },
      ],
      shipped: [
        {
    ...
    quotes: [
      {
        ...
        author: 'Chris Stone · Head of Design, Fractional (former Director of Design, Bench)',
      },
    ],
  },
  MOGO: {
    ...
    tldr:
      "Mogo's mission was to help Canadians get financially fit. I joined before the IPO and spent five years growing with the company: from Senior Designer shipping the web MVP, to Lead Designer running the team and designing products across a platform that scaled from two products to seven. I carried both an IC hat and a leadership hat the whole way through.",
    gallery: [
      { src: '/images/Mogo/01%20-%20MogoMoney.jpg', alt: 'Mogo Money product — additional screen' },
      { src: '/images/Mogo/02%20-%20MogoCrypto.jpg', alt: 'Mogo Crypto' },
      { src: '/images/Mogo/03%20-%20MogoSpend.jpg', alt: 'Mogo Spend — additional screen' },
    ],
    shipped: [
      {
        title: 'MogoCrypto',
  ...
  'IBS & ME': {
    ...
    tldr:
      'Getting diagnosed with IBS means starting a low-FODMAP elimination diet: a 6-12 week process of cutting hundreds of foods, reintroducing them one at a time every 3 days, and tracking symptoms to identify personal triggers. The only tools available were spreadsheets and printed food lists. I went through it myself with nothing but a spreadsheet. So I designed something better.',
    shipped: [],
    quotes: [],
  },
  QUDOS: {
  ...
  INVOKE: {
    tldr:
      'Worked for Invoke Labs, an incubator focused on helping startups define design strategies, grow their vision and brand, and ship strong MVPs across multiple products and services.',
    quotes: [],
  },
  DSQUARE: {
  ...
  'FROMME HERE': {
    subtitle: 'Founder',
    tldr:
      'During Covid I was spending most of my time on the trails of the North Shore. I wanted to create something local: a brand riders could identify with and that gave back to the community maintaining those trails. So I built a headwear brand. Short ride, but a fun one.',
      gallery: [
...
export const SCROLL_SCRUB_ALPHA = 0.14;
